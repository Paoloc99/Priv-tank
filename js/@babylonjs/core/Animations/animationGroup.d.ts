...
export declare class AnimationGroup implements IDisposable {
     ...
     */
    static ClipKeys(sourceAnimationGroup: AnimationGroup, fromKey: number, toKey: number, name?: string): AnimationGroup;
    /**
     ...
     */
    static ClipKeysInPlace(animationGroup: AnimationGroup, fromKey: number, toKey: number): AnimationGroup;
    /**
